(function ($) {
    ...
    var venueAddress = "City Stars, Omar Ibn El-Khattab, Masaken Al Mohandesin, Nasr City, Cairo Governorate, Egypt", // Venue Address
        eventInfo = ["Intercontinental City Stars Cairo Hotel ", "3-4 May 2015"]; // Event Info
    ...
    var fn = {
        ...
        MainSliderAlign: function () {
            var imageWidth, widthFix, container = $('.header');
                        ...
                        success: function () {
                            ...
                            $(".rigster_statu").show();
                                window.setTimeout(function() {
                                  $(".rigster_statu").fadeTo(500, 0).slideUp(500, function(){
                                          $(this).hide();
                                  });
                                }, 5000);
                        }
                ...
                if (isValidEmail(smail)) {
                    $.ajax({
                        ...
                        success: function () {
                            ...
                            $(".subscribe_statu").show();
                                window.setTimeout(function() {
                                  $(".subscribe_statu").fadeTo(500, 0).slideUp(500, function(){
                                          $(this).hide();
                                  });
                                }, 5000);
                        }
